...
public class FundFlowController {
    ...
    @RequestMapping("get_flow_by_user_id")
    public ResponseDTO queryFundFlowByUserId(@RequestBody QueryFundFlowVO vo)  {
        return fundFlowService.queryFundFlowByUserId(vo);
    }
